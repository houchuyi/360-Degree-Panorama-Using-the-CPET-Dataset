...
for i in range(10):
    ...
    # import images
    image = cv.imread('./data/omni_image'+str(i)+'/image_for_matching.png')
    img.append(image)
...
good = obtain_good_matches(bf,dess[0],dess[2])


img3 = cv.drawMatchesKnn(img[0],kps[0],img[2],kps[2],good,None,flags=cv.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)

...
dst = '../data/omni_image'
frame = '/frame000251_2018_09_04_17_44_22_923984.png'

for i in range(0,10):
    shutil.copy2(src+str(i)+frame, dst+str(i)+'/image.png')
...
for i in range(10):
    ...
    h, w = img.shape[:2]
    cv.imwrite('../data/omni_image'+str(i)+'/image_for_stitching.png',image_gamma_correct[0:h,0:w,:])
    ###################################################################################
